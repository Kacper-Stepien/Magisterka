...
Write-Host "==========================================="
Write-Host ">>> ROZPOCZYNAM TESTY DLA S2 (wybrane dane) zoptymalizowane <<<"
Write-Host "==========================================="
foreach ($vus in $scenarios) {
    for ($i = 1; $i -le 3; $i++) {
...
Write-Host "==========================================="
Write-Host ">>> ROZPOCZYNAM TESTY DLA S3 (wybrane dane) zoptymalizowane<<<"
Write-Host "==========================================="
foreach ($vus in $scenarios) {
    for ($i = 1; $i -le $liczbaTestow; $i++) {
...
foreach ($vus in $scenarios) {
    for ($i = 1; $i -le $liczbaTestow; $i++) {
        Write-Host "S4. GraphQL  wybrane dane zoptymalizowane - Uruchamiam test #$i dla VUS: $vus"
